...
def recommend():
    ...
    return render_template('recommend.html',title=title,poster=poster,overview=overview,vote_average=vote_average,release_date=release_date,runtime=runtime,genres=genres,movie_cards=movie_cards,casts=casts,cast_details=cast_details)
